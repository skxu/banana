...
var tp_xAxis = d3.svg.axis().scale(x).orient("bottom"),
    tp_xAxis2 = d3.svg.axis().scale(x2).orient("bottom"),
    tp_yAxis = d3.svg.axis().scale(y).orient("left");
...
var asi_xAxis = d3.svg.axis().scale(x).orient("bottom"),
    asi_xAxis2 = d3.svg.axis().scale(x2).orient("bottom"),
    asi_yAxis = d3.svg.axis().scale(y).orient("left");
...
var tsip_xAxis = d3.svg.axis().scale(x).orient("bottom"),
    tsip_xAxis2 = d3.svg.axis().scale(x2).orient("bottom"),
    tsip_yAxis = d3.svg.axis().scale(y).orient("left");
...
d3.csv("trace09.csv", type, function(error, data) {
